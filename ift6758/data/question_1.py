...
if __name__ == "__main__":
    ...
    # print(df.head())
    # r = get_data_season("2017","2018","ift6758/data/data_saved/season_2017_2018.json")
    r2 = get_data_play_by_play("2017020001","ift6758/data/data_saved/play_by_play_2017020001.json")